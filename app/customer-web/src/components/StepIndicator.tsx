...
export const StepIndicator: React.FC = () => {
  ...
  const steps: { id: AppStep; label: string; icon: React.ReactNode }[] = [
    { id: 'specs', label: '1. Specs', icon: <FileSliders className="w-4 h-4" /> },
    { id: 'payment', label: '2. Payment', icon: <CreditCard className="w-4 h-4" /> },
    { id: 'thankyou', label: '3. Collection Code', icon: <Ticket className="w-4 h-4" /> },
  ];
