...
// Prioritize AUTOPRINT_DATA_DIR, then local/project datastore, then C:\AutoPrint\Data
...
function resolveCorsOrigins(): string[] {
  const raw = process.env.CORS_ORIGIN || 'http://localhost:3000,http://localhost:3001,http://localhost:5000,http://localhost:5173,http://localhost:8085';
...
export const CONFIG = {
  ...
  MERCHANT_PORT:        Number(process.env.MERCHANT_PORT || 3001),
  CUSTOMER_PORT:        Number(process.env.CUSTOMER_PORT || 3000),
