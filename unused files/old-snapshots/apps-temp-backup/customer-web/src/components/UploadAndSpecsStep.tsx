...
const SAMPLE_DOCS: { name: string; size: number; totalPages: number; type: string }[] = [
  { name: 'Semester_Assignment_Final.pdf', size: 3450000, totalPages: 12, type: 'application/pdf' },
  { name: 'Resume_SoftwareEngineer.docx', size: 450000, totalPages: 2, type: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' },
  { name: 'Govt_ID_Pass_Photo.jpg', size: 1200000, totalPages: 1, type: 'image/jpeg' },
];
