...
export const TOTAL_STEPS = 6; // 0: Splash, 1: Shop Details, 2: Payment Setup, 3: Printers, 4: Terms, 5: Admin Security
...
export function useOnboarding() {
  ...
  const updatePaymentConfig = (config: Partial<OnboardingState['paymentConfig']>) => {
    setState((prev) => ({
      ...prev,
      paymentConfig: {
        ...prev.paymentConfig,
